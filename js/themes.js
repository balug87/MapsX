...
export const THEMES = [
  ...
  },
  {
    ...
    blurb: 'Chunky pixels & sprite colors from a lost NES cartridge',
    fonts: {
      label: 'Press Start 2P Regular',
      italic: 'Press Start 2P Regular',
      display: 'Press Start 2P Regular',
    },
    uiFonts: {
      display: '"Press Start 2P", monospace',
      body: '"VT323", monospace',
    },
    // Render the map at low resolution and upscale nearest-neighbor
    // (screen and print) — this is what makes everything actually pixelated.
    pixelScale: 0.5,
    textScale: 1.3,
    colors: {
      background: '#78c850',
      ...
      aeroway: '#a8a8a8',
      building: '#c85c20',
      buildingOutline: '#402000',
      path: '#a05018',
      minor: '#f8f8f8',
      minorCasing: '#404040',
      secondary: '#f8d038',
      secondaryCasing: '#684c00',
      primary: '#f8a030',
      primaryCasing: '#642800',
      motorway: '#f85838',
      motorwayCasing: '#500000',
      rail: '#585858',
      boundary: '#d838cc',
      text: '#ffffff',
      textHalo: '#000000',
    ...
    poiChars: {
      // NES-flavored silhouettes (box-drawing / symbols the pixel font can draw)
      food: '♣',
      cafe: '☕',
      drink: '♦',
      shop: '$',
    ...
    // Slightly thicker road casings for chunky pixel roads
    roadCasingExtra: 1.4,
    boundaryDash: [2, 2],
    pathDash: [1, 1],
    uiVars: {
      '--bg': '#0f0f23', '--panel': '#1d2b53', '--panel-edge': '#83769c',
      '--ink': '#fff1e8', '--muted': '#9c8ab0', '--accent': '#ff004d',
      '--btn-bg': '#ff004d', '--btn-ink': '#fff1e8', '--radius': '0px',
    },
    effect: 'pixelate',
    exportFrame: 'arcade',
  },
